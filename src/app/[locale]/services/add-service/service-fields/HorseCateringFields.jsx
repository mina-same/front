...
const HorseCateringFields = ({
  ...
  // Make sure we're working with a properly initialized horse_catering object
  React.useEffect(() => {
    ...
    <div className="space-y-6">
      <div className="relative">
        <div className="flex justify-between items-center mb-2">
          ...
          <button
            type="button"
            onClick={() => addNestedArrayItem('horse_catering.additionalServices')}
        ...
        {additionalServices.length > 0 ? (
          <div className="space-y-4 mt-2">
            {additionalServices.map((service, index) => (
              <div key={index} className="p-4 border border-gray-200 rounded-lg relative">
                <button
                  type="button"
                  onClick={() => removeNestedArrayItem('horse_catering.additionalServices', index)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleNestedArrayChange('horse_catering.additionalServices', index, 'name_ar', e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleNestedArrayChange('horse_catering.additionalServices', index, 'name_en', e.target.value)}
                      className={inputClass('')}
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="number"
                        value={service.price || ""}
                        onChange={(e) => handleNestedArrayChange('horse_catering.additionalServices', index, 'price', e.target.value)}
          ...
          <div className="text-center p-4 border border-dashed border-gray-300 rounded-lg">
            <p className="text-gray-500">No catering services added yet</p>
...
export default HorseCateringFields;
