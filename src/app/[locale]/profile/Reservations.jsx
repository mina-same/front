  ...
  return (
    <div className="">
      ...
      <div className="bg-white p-10 min-h-[700px] flex flex-col jsutify-center">
        ...
        <div className="pt-4 flex gap-4 border-b border-gray-200 overflow-x-auto">
        ...
        {filteredReservations.length === 0 ? (
          <div className="gap-2 flex flex-col sm:flex-row h-full justify-center items-center bg-gray-50 py-5 rounded-xl min-h-[500px]">
            <Calendar className="w-8 h-8 text-gray-600" />
            <p className="text-gray-600 text-center">
              {t("profile:noReservationsFound")}
            </p>
          </div>
        ) : (
                ...
                <div className="flex flex-row    sm:flex-col items-start sm:items-center justify-between gap-4">
                  ...
                  <div className="flex justify-end items-center gap-3 w-full sm:w-auto">
                    <div className="relative w-12 h-12 flex-shrink-0">
                      ...
                      />
                      <div
                        className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center border-2 border-white ${getStatusBackgroundColor(
                          reservation.status
                        )}`}
                      >
                  ...
                  <div className="flex justify-end items-center gap-3 w-full sm:w-auto">
                    {reservation.status === "pending" ? (
                      <div className="flex gap-2 w-full sm:w-auto">
                        <button
                          onClick={() =>
                            onStatusUpdate(reservation._id, "approved")
                          }
                        ...
                        <button
                          onClick={() =>
                            onStatusUpdate(reservation._id, "rejected")
                          }
