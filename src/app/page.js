						...
						<div className="pt-12 text-center">
							...
							<div className="max-w-2xl mx-auto mb-8">
								<h2 className="text-3xl lg:text-5xl lg:leading-normal mb-4 font-bold font-heading wow animate__animated animate__fadeIn">
									Passionate about Horses <br />
									Dedicated <span className="text-blue-500">to Your Equestrian Journey</span>
								</h2>
								<div className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn d-inline">
									We are <strong className="text-blue-500">Tairia Horses</strong>, your trusted partner in{" "}
									<div className="typewrite d-inline text-brand">
										<TextEffect
											texts={["Horse Rentals", "Training & Care", "Veterinary Services"]}
											typingSpeed={100}
											deletingSpeed={50}
								...
								<div className="lg:py-6 lg:pr-77 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
									...
									<div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
										...
										<div>
											...
											<p className="text-blueGray-400 leading-loose pr-12">At "Nation Horses," we connect riders with professionals, offering easy access to equestrian resources and knowledge.</p>
										</div>
									</div>
									...
									<div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
										...
										<div>
											<h3 className="mb-2 text-xl font-semibold font-heading">Horses Nation</h3>
											<p className="pr-12 text-blueGray-400 leading-loose">Join "Horses Nation" for training, competitions, and a community focused on horse care.</p>
										</div>
									</div>
									...
									<div className="flex items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
										...
										<div>
											<h3 className="mb-2 text-xl font-semibold font-heading">Elevate Your Skills</h3>
											<p className="text-blueGray-400 leading-loose pr-12">Access resources for skill development, training, and competitions in the equestrian world.</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
							<div className="w-full lg:w-1/2 mb-4 lg:mb-0">
								<h2 className="text-3xl md:text-4xl font-bold font-heading wow animate__animated animate__fadeInDown">
									...
									<span className="text-blue-500"> Taiara Horses</span>
									<br />
									<span>Your gateway to the world of equestrianism</span>
								</h2>
							</div>
							<div className="w-full lg:w-1/2">
								<p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn">
									Join us in a supportive environment where riders and their horses connect, grow, and thrive. From training to competitions, we aim to enrich your equestrian experience with resources, knowledge, and opportunities tailored to your needs.
								</p>
							</div>
						</div>
							...
							<div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
								<div className="p-12 bg-white shadow rounded">
									...
									<Image
										...
										alt="Workshops" />
									<h3 className="mb-2 font-bold font-heading text-xl">Workshops & Training</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">
										Learn and enhance your equestrian skills through our expert-led workshops and training programs designed for all levels.
									</p>
								</div>
							</div>
							<div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
								<div className="p-12 bg-white shadow rounded">
									...
									<Image
										...
										alt="Community" />
									<h3 className="mb-2 font-bold font-heading text-xl">Community Connection</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">
										Connect with a network of riders, trainers, and enthusiasts to share experiences, exchange ideas, and build lasting relationships.
									</p>
								</div>
							</div>
							<div className="hover-up-5 w-full lg:w-1/3 px-3 mb-6">
								<div className="p-12 bg-white shadow rounded wow animate__animated animate__fadeIn" data-wow-delay=".7s">
									...
									<Image
										...
										alt="Resources" />
									<h3 className="mb-2 font-bold font-heading text-xl">Resources & Knowledge</h3>
									<p className="text-sm text-blueGray-400 leading-relaxed">
										Access a wealth of resources, from proper horse care tips to marketing products and advertising your equestrian résumé.
									</p>
								</div>
							</div>
						</div>
							...
							<div className="relative w-full lg:w-1/3 mb-8 lg:mb-0 text-center lg:text-left">
								<div className="max-w-md lg:max-w-xs lg:pr-16 mx-auto lg:ml-0 mb-6 lg:mb-0">
									<h2
										...
										data-wow-delay=".3s"
									>
										Empowering <span className="text-blue-500">Equestrian</span> Connections
									</h2>
									<p
										className="text-xs md:text-base text-blueGray-400 leading-loose wow animate__animated animate__fadeIn"
										data-wow-delay=".9s"
									>
										Discover a supportive platform where riders and horses thrive, offering resources for training, care, and skill development.
									</p>
								</div>
							</div>
					...
					<div className="container px-4 mx-auto">
						<div className="relative py-20 px-4 lg:p-20">
							...
							<h2 className="mb-4 text-3xl lg:text-4xl font-bold font-heading wow animate__animated animate__fadeIn">
									...
									<span className="text-blue-500">Homeland Horses</span>
									<span> Join Our Newsletter</span>
								</h2>
								<p className="mb-8 text-blueGray-400 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
									Receive the latest equestrian insights, tips, and special offers straight to your inbox.
								</p>
