...
// import { GoogleOAuthProvider, GoogleLogin } from '@react-oauth/google'; // Add Google OAuth
...
//     { key: 'user:horse_trainer', icon: MdSportsMartialArts }, // Changed
//     { key: 'user:horse_haircut', icon: MdFitnessCenter }, // Changed
//     { key: 'user:horse_trimmer', icon: MdFitnessCenter }, // Changed
//     { key: 'user:horse_housing', icon: FaBriefcase }, // Changed
//     { key: 'user:housing_caravan', icon: FaBriefcase }, // Changed
//     { key: 'user:horse_catering', icon: FaShoppingCart }, // Changed
//     { key: 'user:horse_courses_maker_or_provider', icon: FaBook }, // Changed
//     { key: 'user:e_library_provider', icon: FaBook }, // Changed
//     { key: 'user:horse_doctor', icon: FaStethoscope }, // Changed
//     { key: 'user:judge', icon: FaClipboardCheck },
//     { key: 'user:marketer_and_promoter', icon: FaUsers }, // Changed
...
//     { key: 'user:trip_organizer', icon: FaRunning }, // Changed
//     { key: 'user:competition_organizer', icon: FaRunning }, // Changed
...
//       setAuthenticated(true);
//       setIsEmailVerified(true); // Google users are auto-verified
//       localStorage.setItem('userId', data.userId);
//       setStep(3); // Skip to personal info since email is verified
//     } catch (err) {
...
//                         ? 'bg-blue-500 text-white' // Completed steps
//                         : step === i + 1
//                           ? 'bg-gray-500 text-white' // Current step
//                           : 'bg-gray-200 text-gray-600' // Future steps
//                         }`}
//                     >
...
//                   <div
//                     key={i}
//                     className={`h-full flex-1 ${step > i + 1
